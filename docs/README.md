...
- **Terminal Demo**: Real Docker command examples
- **Dark/Light Theme**: Optimized for readability

### Content Sections
- **Hero Section**: Value proposition with MySQL & PostgreSQL support
- **Features Grid**: Key benefits and capabilities
- **Docker Quick Start**: 1-minute Docker deployment guide
...
- Custom domain: tenangdb.ainun.cloud
- Pushes to `gh-pages` branch deploy automatically
